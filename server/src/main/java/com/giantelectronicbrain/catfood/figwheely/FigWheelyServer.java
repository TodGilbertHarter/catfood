package com.giantelectronicbrain.catfood.figwheely;
...
public class FigWheelyServer extends AbstractVerticle {
	...
	private static class Watchable {
		...
		public Watchable(String url, String root, GWTCompiler handler) {
			this.url = url;
			this.root = root;
	...
	public static Handler<RoutingContext> staticHandler(String root, String urlWithoutAsterix) {
		...
		return StaticHandler.create(root).setCachingEnabled(false).setDefaultContentEncoding(GWTCompiler.charset);
	}
	...
	public static void addWatchable(String url, String root, GWTCompiler handler) {
