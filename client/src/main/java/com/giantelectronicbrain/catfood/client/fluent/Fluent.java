...
//tgh, I don't know how to do this in elemental2...
		if (!GWT.isClient()) {
			return this;
		}
		for (String js : jss) {
	...
	//TODO: Figure out how to support click() if needed...
	public Fluent click() {
//		((Element) element).click();
		throw new UnsupportedOperationException("I don't know how to do click() in Elemental2!");
//		return this;
	}
}